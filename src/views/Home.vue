<template>
    <div>
        ...
        <div class="banner">
            <h1>Gulu UI</h1>
            <h2>Vue UI library developed by Allengl</h2>
            <p class="actions">
                <a href="https://github.com/Allengl/gulu-UI">Github</a>
            ...
            <div class="container">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="info">
                            <h1>Easy to Use</h1>
                            <h2>It's just easy to use, that's all.</h2>
                        </div>
                    </li>
                </ul>
            </div>
