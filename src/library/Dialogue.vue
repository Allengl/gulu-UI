<template>
    <template v-if="isVisible">
        <Teleport to="body">
            <div class="gulu-dialogue-overlay" @click="onClickOverlay"></div>
                <div class="gulu-dialogue-wrapper">
                    <div class="gulu-dialogue">
                        <header>
                            <slot name="title"/>
                            <span @click="close" class="gulu-dialogue-close"></span> </header>
                        <main>
                            <slot name="content"/>
                        </main>
                        <footer>
